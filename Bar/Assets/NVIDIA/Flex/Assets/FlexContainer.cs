...
namespace NVIDIA.Flex
{
    ...
    public class FlexContainer : ScriptableObject
    {
        ...
        public void Reset()
        {
            //m_fluidMaterial = FluidMaterial.Instance.material; mine
        }
        ...
        {
            m_drawFluidHelper.enabled = false;
            m_drawFluidHelper.enabled = true;

            //m_drawFluidHelper.Destroy();
            //m_drawFluidHelper.Create();

            //m_drawFluidHelper = null;
        }

        public void UpdateDrawFluid(ParticleData _particleData)
        {
        ...
        [SerializeField]
        public Material m_fluidMaterial;
