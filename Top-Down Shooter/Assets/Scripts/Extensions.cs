...
public static class Extensions
{
    ...
    public static bool Vector2AboutSame(Vector2 a, Vector2 b, int powerOfTen)
    {
        return FloatAboutSame(a.x, b.x, powerOfTen) && FloatAboutSame(a.y, b.y, powerOfTen);
    }

    public static bool FloatAboutSame(float a, float b, int powerOfTen)
    {
        float acc = Mathf.Pow(10, powerOfTen);
        return (Mathf.RoundToInt(a * acc) / acc == Mathf.RoundToInt(b * acc) / acc);
    }
}