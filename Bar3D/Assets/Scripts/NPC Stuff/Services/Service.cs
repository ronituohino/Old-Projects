...
{
    public abstract Transform ReserveRandomServicePoint(NPC customer);

    public abstract bool HasFreeSpace();

    public abstract void Arrive(NPC customer, Transform point);

    internal abstract void Release(NPC customer, Transform point);
}