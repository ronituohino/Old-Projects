...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        bool IsServerOnlineSceneChangeNeeded()
        {
            ...
            return false;//!string.IsNullOrEmpty(onlineScene) && !IsSceneActive(onlineScene) && onlineScene != offlineScene;
        }
        ...
        void OnClientAuthenticated(NetworkConnection conn)
        {
            ...
            if (true/*string.IsNullOrEmpty(onlineScene) || onlineScene == offlineScene || IsSceneActive(onlineScene)*/)
            {
